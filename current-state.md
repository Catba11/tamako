...
A living document. Update it at every milestone. Last update: Phase 2
started — the embedding sidecar (decision 66) and the shared gate
context view (decision 72) are implemented. Phase 1 shipped as
v0.0.1 (alpha).
...
- **Phase 2 (memory that remembers): STARTED.** Sequenced per
...
60. **Rust lbug 0.18.3 writes storage v43; Python inspection needs
    ...
    -100…9717 graph (uv + python 3.12): 668 nodes, 1205 edges.
